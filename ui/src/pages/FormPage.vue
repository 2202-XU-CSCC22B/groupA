<template>
  <div class="part1">
       ...
       <div v-if="selectedTransaction.includes('sales')">
         ...
         <br>
         <q-input v-model="sales_official_receipt" />
         <br>
         <label>Upload XU Official Receipt:</label>
         <br>
         <q-file v-model="sales_file" />
       </div>
       ...
       <div v-if="selectedTransaction.includes('repair_replacement')">
         ...
         <br>
         <q-file v-model="repair_replacement_file" />
       </div>
